...
- All MCP tool definitions and JSON schemas (45 tools, including workspace_logs, exec_kill, vault tools, orchestration tools, workspace_git_status, snapshot_diff)
...
- 45 MCP tools total (workspace, exec, file, snapshot, fork, vault, orchestration, set_env, git_clone, workspace_git_status, snapshot_diff)
